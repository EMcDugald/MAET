...
utils.ndwrite(exact_sol,"exact_radial2.d")
utils.ndwrite(lapu,"lap_exact_radial2.d")
...
#solution v
v = spec_poi.v2(X1_bg,X2_bg,a/2,a,u)
...
utils.ndwrite(exact_small,"radial_exact_small_fft2.d")
utils.ndwrite(v_small,"radial_v_small_fft2.d")
