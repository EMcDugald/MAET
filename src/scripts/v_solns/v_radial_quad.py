...
utils.ndwrite(exact_sol,"exact_radial3.d")
utils.ndwrite(lapu,"lap_exact_radial3.d")
...
#solution v
v = spec_poi.v_quad(X1_bg,X2_bg,a/2,a,u)
...
utils.ndwrite(exact_small,"radial_exact_small_quad.d")
utils.ndwrite(v_small,"radial_v_small_quad.d")

end = time.time()
print("Elapsed Time for Quad Based Computation:",end-start)
